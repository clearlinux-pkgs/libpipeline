...
Source0  : https://download.savannah.nongnu.org/releases/libpipeline/libpipeline-1.5.6.tar.gz
Source1  : https://download.savannah.nongnu.org/releases/libpipeline/libpipeline-1.5.6.tar.gz.asc
...
%prep
%setup -q -n libpipeline-1.5.6
cd %{_builddir}/libpipeline-1.5.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650845256
...
cp %{_builddir}/libpipeline-1.5.6/COPYING %{buildroot}/usr/share/package-licenses/libpipeline/31a3d460bb3c7d98845187c716a30db81c44b615
%make_install
...
/usr/lib64/libpipeline.so.1.5.6
