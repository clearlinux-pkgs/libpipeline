...
#
# Source0 file verified with key 0xF6DD330210FA4CD1 (cjwatson@debian.org)
#
Name     : libpipeline
Version  : 1.5.4
Release  : 23
URL      : https://download.savannah.nongnu.org/releases/libpipeline/libpipeline-1.5.4.tar.gz
Source0  : https://download.savannah.nongnu.org/releases/libpipeline/libpipeline-1.5.4.tar.gz
Source1  : https://download.savannah.nongnu.org/releases/libpipeline/libpipeline-1.5.4.tar.gz.asc
...
%prep
%setup -q -n libpipeline-1.5.4
cd %{_builddir}/libpipeline-1.5.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636483668
...
cp %{_builddir}/libpipeline-1.5.4/COPYING %{buildroot}/usr/share/package-licenses/libpipeline/31a3d460bb3c7d98845187c716a30db81c44b615
%make_install
...
/usr/lib64/libpipeline.so.1.5.4
